...
it('should set nextStep', () => {
  ...
  const nextButton = container.querySelector('.bp4-intent-primary');
...
it('should not have prevStep button in the first step', () => {
  ...
  story.slides.forEach((_, index) => {
    const buttons = container.querySelectorAll('.bp4-button');
...
it('should set prevStep', () => {
  ...
  const prevButton = container.querySelector('.bp4-button');
